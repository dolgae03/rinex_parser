...
[input_dir, nav_file, output_dir, selected_obs_file] = prepare_endpoint_inputs(endpoint_root);
display_rows = 5;
...
disp(['run_current_test observation: ' selected_obs_file]);
disp('run_current_test finished');
